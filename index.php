        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="owl-carousel slider-utama owl-theme">
                 <div>
                     <img src="assets/img/slider/Shoes1.png" alt="">
                 </div>
                 <div>
                     <img src="assets/img/slider/header2.png" alt="">
                 </div>
                 <div>
                     <img src="assets/img/slider/header.png" alt="" class="img-responsive">
                 </div>
                  <div>
                     <img src="assets/img/slider/slider2.png" alt="" class="img-responsive">
                 </div>
                  <div>
                     <img src="assets/img/slider/slider6.png" alt="" class="img-responsive">
                 </div>
             </div> 
             <hr>
             <!-- Akhir Slider -->
